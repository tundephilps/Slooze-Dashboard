...
import { useTheme } from "../../context/ThemeContext"; // Make sure you have a theme context
        ...
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data}>
            ...
            <Line
              type="monotone"
              dataKey="current"
              stroke={theme === "light" ? "#dec224" : "#4CAF50"} // Light: gold, Dark: green
              strokeWidth={2}
              dot={false}
            />
          </LineChart>
...
export default TotalEarningCard3;
